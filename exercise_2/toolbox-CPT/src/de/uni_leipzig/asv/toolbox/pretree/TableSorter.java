...
public class TableSorter extends AbstractTableModel {
	...
	protected Comparator<Object> getComparator(int column) {
		...
		Comparator<Object> comparator = this.columnComparators.get(columnType);
		if (comparator != null) {
			return comparator;
		}
	...
	private class Row implements Comparable {
		...
		public int compareTo(Object o) {
			...
			for (Directive directive : TableSorter.this.sortingColumns) {
				...
				Object o1 = TableSorter.this.tableModel
						.getValueAt(row1, column);
				Object o2 = TableSorter.this.tableModel
						.getValueAt(row2, column);
	...
	private class TableModelHandler implements TableModelListener {
		public void tableChanged(TableModelEvent e) {
			...
			if ((e.getFirstRow() == e.getLastRow())
					...
					&& (getSortingStatus(column) == TableSorter.NOT_SORTED)
	...
	private class SortableHeaderRenderer implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table,
				...
				int column) {
			Component c = this.tableCellRenderer.getTableCellRendererComponent(
